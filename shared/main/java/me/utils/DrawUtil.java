...
public final class DrawUtil {
    ...
    public static double[] worldToScreen(final double[] positionVector,
                                         final IAxisAlignedBB boundingBox,
                                         final double[] projection,
                                         final double[] projectionBuffer) {
        final double[][] bounds = {
                {boundingBox.getMinX(), boundingBox.getMinY(), boundingBox.getMinZ()},
                {boundingBox.getMinX(), boundingBox.getMaxY(), boundingBox.getMinZ()},
                {boundingBox.getMinX(), boundingBox.getMaxY(), boundingBox.getMaxZ()},
                {boundingBox.getMinX(), boundingBox.getMinY(), boundingBox.getMaxZ()},
                {boundingBox.getMaxX(), boundingBox.getMinY(), boundingBox.getMinZ()},
                {boundingBox.getMaxX(), boundingBox.getMaxY(), boundingBox.getMinZ()},
                {boundingBox.getMaxX(), boundingBox.getMaxY(), boundingBox.getMaxZ()},
                {boundingBox.getMaxX(), boundingBox.getMinY(), boundingBox.getMaxZ()}
        };
    ...
    public static void glDrawArcFilled(final double x,
        ...
        glBegin(GL_POLYGON);
        {
            ...
            final float[][] vertices = me.utils.MathUtil.getArcVertices(radius, angleStart, angleEnd, segments);
