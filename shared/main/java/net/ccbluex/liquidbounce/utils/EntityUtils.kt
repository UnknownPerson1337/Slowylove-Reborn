...
object EntityUtils : MinecraftInstance() {
    ...
    fun isAnimal(entity: IEntity?): Boolean {
        return classProvider.isEntityAnimal(entity) || classProvider.isEntitySquid(entity) || classProvider.isEntityGolem(
            entity
        ) ||
                classProvider.isEntityBat(entity)
    }

    fun isMob(entity: IEntity?): Boolean {
        return (classProvider.isEntityMob(entity) || classProvider.isEntityVillager(entity) || classProvider.isEntitySlime(
            entity
        )
                || classProvider.isEntityGhast(entity) || classProvider.isEntityDragon(entity) || classProvider.isEntityShulker(
            entity
        ))
    }
