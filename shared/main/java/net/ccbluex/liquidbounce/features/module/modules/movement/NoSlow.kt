...
@ModuleInfo(name = "NoSlowDown",description = "取消灵魂沙和使用物品时造成的减速效果",
    category = ModuleCategory.MOVEMENT)
class NoSlow : Module() {
    private val msTimer = MSTimer()
    private val modeValue = ListValue("PacketMode", arrayOf("AntiCheat", "Custom", "NCP", "Vanilla", "AAC", "AAC5"), "Vanilla")
