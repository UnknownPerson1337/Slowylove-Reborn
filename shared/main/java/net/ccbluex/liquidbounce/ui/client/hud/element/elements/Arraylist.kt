...
//import net.ccbluex.liquidbounce.ui.client.keybind.Verify.ShadowUtils

import me.utils.BlurUtils
import me.utils.ShadowUtils
...
class Arraylist(x: Double = 1.0, y: Double = 2.0, scale: Float = 1F,
    ...
    private val fadeSpeed = FloatValue("Gradinet-Speed", 800f, 100f, 1000f)
        ...
        for (module in sortedModules) {
            ...
            if (module.array && (module.state || module.slide != 0F)) {
                ...
                when (hAnimation.get()) {
                    ...
                    "Slide" -> {
                        if (module.state) {
                            if (module.slide < width) {
                                module.slide = AnimationUtils2.animate(width.toDouble(), module.slide.toDouble(), animationSpeed.get().toDouble() * 0.025 * delta.toDouble()).toFloat()
                                module.slideStep = delta / 1F
                            }
                        } else if (module.slide > 0) {
                            module.slide = AnimationUtils2.animate(-width.toDouble(), module.slide.toDouble(), animationSpeed.get().toDouble() * 0.025 * delta.toDouble()).toFloat()
            ...
            if (module.array && module.slide > 0F) {
                ...
                when (vAnimation.get()) {
                    ...
                    "Slide", "Rise" -> module.arrayY = AnimationUtils2.animate(yPos.toDouble(), module.arrayY.toDouble(), animationSpeed.get().toDouble() * 0.025 * delta.toDouble()).toFloat()
                    "Astolfo" -> {
                        if (module.arrayY < yPos) {
                            ...
                            RenderUtils.drawRect(
                                ...
                                when (shadowColorMode.get().toLowerCase()) {
                                    ...
                                    "text" -> {
                                        ...
                                        val color3: Int
                                        color3 = VisualUtils.getGradientOffset(Color(textRed.get(), textGreen.get(), textBlue.get(),1), Color(textRed2.get(), textGreen2.get(), textBlue2.get(),1), (Math.abs(
                                            System.currentTimeMillis() / fadeSpeed.get()
                                        ...
                                        when {
                                            ...
                                            colorMode.equals("Gradinet", true) ->color3
                                            else -> customColor
                                        }
                                    }
...
//                            rectcolorMode.equals("Gradinet", ignoreCase = true) -> color3
                            rectColorMode.equals("Gradinet", ignoreCase = true) -> color3
                ...
                modules.forEachIndexed { index, module ->
                    ...
                    if (!rectLeftValue.get().equals("none", true)) {
                        val rectColor = when {
                            ...
                            rectColorMode.equals("LiquidSlowly", ignoreCase = true) -> LiquidSlowly
                            rectColorMode.equals("Fade", ignoreCase = true) -> FadeColor
                            rectColorMode.equals("Gradinet", true) -> color3
