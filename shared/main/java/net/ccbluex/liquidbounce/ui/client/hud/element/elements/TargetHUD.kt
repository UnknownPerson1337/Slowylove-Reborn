...
class TargetHUD : Element() {
    ...
    override fun drawElement(): Border? {
        ...
        if (classProvider.isGuiHudDesigner(mc.currentScreen) || mc.currentScreen is GuiChat && showUrselfWhenChatOpen.get()) {
            target = mc.thePlayer!!
        }
        if (classProvider.isEntityPlayer(target)) {
            ...
            if (styleValue.get().equals("LiquidBounce")) {
                ...
                if (playerInfo != null) {
                    ...
                    // Draw head
                    drawHead(mc.netHandler.getPlayerInfo(target.uniqueID)!!.locationSkin, 30, 30)
                }
            }
            if (styleValue.get().equals("Novoline")) {
                ...
                drawPlayerHead(mc.netHandler.getPlayerInfo(target.uniqueID)!!.locationSkin, 0, 0, 36, 36)
                Fonts.minecraftFont.drawStringWithShadow(target!!.name!!, (2F + 36F).toInt(), 2, -1)
                ...
                Fonts.fontSFUI35.drawStringWithShadow(
                    "❤",
                    (Fonts.minecraftFont.getStringWidth("${decimalFormat.format(percent)}") + 40).toInt(),
                    27,
            ...
            if (styleValue.get().equals("Novoline2")) {
                ...
                drawPlayerHead(mc.netHandler.getPlayerInfo(target.uniqueID)!!.locationSkin, 3, 3, 30, 30)
            ...
            if (styleValue.get().equals("Novoline3")) {
                ...
                RenderUtils.drawGradientSideways(
                    ...
                    24.0, Palette.fade2(customColor, counter1[0], Fonts.fontSFUI35.fontHeight).rgb,
                    Palette.fade2(customColor1, counter2[0], Fonts.fontSFUI35.fontHeight).rgb
                )
                easingHealth += ((target!!.health - easingHealth) / 2.0F.pow(10.0F - fadeSpeed.get())) * RenderUtils.deltaTime
                Fonts.minecraftFont.drawString(target!!.name!!, 34, 4, Color(255, 255, 255, 255).rgb)
                drawPlayerHead(mc.netHandler.getPlayerInfo(target.uniqueID)!!.locationSkin, 2, 2, 30, 30)
                Fonts.minecraftFont.drawStringWithShadow(
                    BigDecimal((target!!.health / target!!.maxHealth * 100).toDouble()).setScale(
                        1,
                        BigDecimal.ROUND_HALF_UP
                    ).toString() + "%", (width / 2F + 5.5F).toInt(), 17, Color.white.rgb
                )
            }
            if (styleValue.get().equals("Astolfo")) {
                ...
                RenderUtils.drawEntityOnScreen(-18, 47, 30,target)
                RenderUtils.drawRect(
                    -38,
                    -14,
                    133,
                    52,
                    Colors.getColor(0, 0, 0, 180)
                )
                mc.fontRendererObj.drawStringWithShadow(target!!.name!!, 0, (-8.0f).toInt(), Color(255, 255, 255).rgb)
                RenderUtils.drawRect(0, (8.0f + Math.round(40.0f)).toInt(), 130, 40, colors2)
                if (target!!.health / 2.0f  / 2.0f > 1.0) {
                    RenderUtils.drawRect(
                        0,
                        (8.0f + Math.round(40.0f)).toInt(),
                        ((target!!.health / target!!.maxHealth) * additionalWidth).toInt() + 5,
                        40,
                        colors1
                    )
                }
                RenderUtils.drawRect(
                    0,
                    (8.0f + Math.round(40.0f)).toInt(),
                    ((easingHealth / target!!.maxHealth) * additionalWidth).toInt(),
                    40,
                    colors
                )
                easingHealth += ((target!!.health - easingHealth) / 2.0F.pow(10.0F - fadeSpeed.get())) * RenderUtils.deltaTime
...
//                val minWidth = 140F.coerceAtLeast(45F + Fonts.font35.getStringWidth(target!!.name!!))
...
//                Fonts.font35.drawString(target!!.name!!, 46, 4, -1)
...
//            }
            if (styleValue.get().equals("Flux")) {
                ...
                drawPlayerHead(mc.netHandler.getPlayerInfo(target.uniqueID)!!.locationSkin, 5, 3, 29, 28)
                ...
                // hp bar
                val yPos = 5 + fontrender.fontHeight + 2f
                if (easingHealth > target!!.health) {
            ...
            if (styleValue.get().equals("Simplicity")) {
                ...
                Fonts.font35.drawStringWithShadow("\u00a7l" + target!!.name, 38, 2, -1)
                if (width < 80.0) {
                    width = 80.0
                }
                if (width > 80.0) {
            ...
            if (styleValue.get().equals("AsuidBounce")) {
                ...
                Fonts.fontSFUI35.drawString(target!!.name!!, 36F, 3f, Color.WHITE.rgb)
                Fonts.fontSFUI35.drawString("Distance", 36F, 14f, Color.WHITE.rgb)
                Fonts.fontSFUI35.drawString(
                    "Armor " + decimalFormat2.format(target!!.totalArmorValue / 2f),
                    36F,
                    24f,
                    Color.WHITE.rgb
                )
                RenderUtils.drawRect(
                    1f,
                    34f,
                    1f + min((Math.round(easingHealth / target!!.maxHealth * 10000) / 80f), 118f),
                    37f,
                    barColor
                )
                RenderUtils.drawRect(
                    75F,
                    25.5f,
                    75F + min((Math.round(target!!.totalArmorValue / 20F * 10000) / 250f), 40f),
                    29.5f,
                ...
                if (target != null) {
                    ...
                    particles.forEachIndexed { index, module ->
                        ...
                        RenderUtils.drawFilledCircle(
                            (20 + module.animaitonX).toInt(),
                            (20 + module.animaitonY).toInt(),
                            module.size,
                    ...
                    val playerInfo = mc.netHandler.getPlayerInfo(target!!.uniqueID)
                    if (playerInfo != null) {
                        val locationSkin = mc.netHandler.getPlayerInfo(target.uniqueID)!!.locationSkin
            ...
            if (styleValue.get().equals("Hanabi")) {
                ...
                this.healthBarWidth2 = AnimationUtils2.animate(hpWidth, this.healthBarWidth2, 0.20000000298023224)
                ...
                this.hudHeight =
                    RenderUtils.getAnimationStateSmooth(40.0, this.hudHeight, (8f / Minecraft.getDebugFPS()).toDouble()).toDouble()
                if (hudHeight == 0.0) {
                ...
                drawPlayerHead(mc.netHandler.getPlayerInfo(target.uniqueID)!!.locationSkin, 2, 2, 33, 33)
                if (easingHealth > target!!.health)
                    RenderUtils.drawRect(
                        0F,
                        37.0f,
                ...
                easingHealth += ((target!!.health - easingHealth) / 2.0F.pow(10.0F - fadeSpeed.get())) * RenderUtils.deltaTime
                Fonts.fontSFUI35.drawStringWithShadow("❤", 112, 28, hurt.rgb)
                Fonts.fontSFUI35.drawStringWithShadow(healthStr, 120, 28, Color.WHITE.rgb)
                Fonts.font35.drawString(
                ...
                Fonts.font40.drawString(target!!.name!!, 38.0f, 4.0f, blackcolor2)
            ...
            if (styleValue.get().equals("Lnk")) {
                ...
                GL11.glPushMatrix()
                GL11.glColor4f(1f, 1f, 1f, 1f)
                RenderUtils.drawEntityOnScreen(10, 33, 16, target)
                GL11.glPopMatrix()
                mc.fontRendererObj.drawStringWithShadow(target!!.name!!, 23, 4, Color.white.rgb)
                ...
                for (index in 3 downTo 0) {
                    ...
                    if (mc.thePlayer!!.inventory.armorInventory[index] != null) {
                        ...
                        mc.fontRendererObj.drawStringWithShadow(
                            ((mc.thePlayer!!.inventory.armorInventory[index]!!.itemDamage - mc.thePlayer!!.inventory.armorInventory[index]!!.itemDamage)).toString(),
                            ((x.toFloat() + 4f) * 1 / 0.65f).toInt(),
                            47,
                            Color.white.rgb
                        )
                ...
                if (mc.thePlayer!!.inventory.mainInventory[mc.thePlayer!!.inventory.currentItem] != null) {
                        ...
                        GlStateManager.scale(0.65, 0.65, 0.65)
                        mc.fontRendererObj.drawStringWithShadow(
                            ((mc.thePlayer!!.inventory.mainInventory[mc.thePlayer!!.inventory.currentItem]!!.itemDamage - mc.thePlayer!!.inventory.mainInventory[mc.thePlayer!!.inventory.currentItem]!!.itemDamage)).toString(),
                            ((x.toFloat() + 4f) * 1 / 0.65f).toInt(),
                            47,
                            Color.white.rgb
                        )
    ...
    private fun drawPlayerHead(skin: IResourceLocation, x: Int, y: Int, width: Int, height: Int) {
        GL11.glColor4f(1F, 1F, 1F, 1F)
        mc.textureManager.bindTexture(skin)
        Gui.drawScaledCustomSizeModalRect(
