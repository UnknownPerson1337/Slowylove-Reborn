...
import net.ccbluex.liquidbounce.utils.HanabiColor
...
object LiquidBounce {
    ...
    // Client information
    const val CLIENT_NAME = "Slowylove"
    ...
    fun startClient() {
        ...
        if(HanabiColor.getDoubleRainbow() && HanabiColor.getHanabiMainColor()) {
            isStarting = true
            ...
            JOptionPane.showMessageDialog(null, "你妈死了.", "L", JOptionPane.ERROR_MESSAGE);
            HanabiColor.getTenacityColor()
            while(0 != 1){
