...
public class ShaderProgram {
    ...
    private static String readShader(String fileName) {
        ...
        try {
            final InputStreamReader inputStreamReader = new InputStreamReader(ShaderProgram.class.getClassLoader().getResourceAsStream(String.format("assets/minecraft/sb/shaders/%s", fileName)));
    ...
    public void renderCanvas(final IScaledResolution scaledResolution) {
